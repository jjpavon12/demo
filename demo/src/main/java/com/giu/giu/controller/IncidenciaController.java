...
public class IncidenciaController {
    ...
    public String registrarIncidencia(@RequestParam String descripcion,
        ...
        try {
            CategoriaIncidencia cat = CategoriaIncidencia.valueOf(categoria.toUpperCase());
            incidenciaService.registrar(descripcion, ubicacion, cat, usuario);
            return "redirect:/ciudadano/incidencias/mis-incidencias?exito";
        } catch (Exception e) {
            System.out.println("Error registrando incidencia: " + e.getMessage());
            e.printStackTrace();
            throw e;
        }
    }
